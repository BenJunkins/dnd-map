...
def import_monsters():
    ...
    try:
        response = http.request('POST', url, body=encoded_body, headers={'Content-Type': 'application/json'})
        ...
        return {'statusCode': 200, 'body': json.dumps(f"Loaded {len(monsters)} monsters.")}
